...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                if (i == 0) {
                    sendDataToWear(weatherId, high, low);
                }
    ...
    private void sendDataToWear(int weatherId, double high, double low) {
        PutDataMapRequest putDataMapReq = PutDataMapRequest.create("/sunshine");

        putDataMapReq.getDataMap().putInt(SUNSHINE_WEATHER_ID, weatherId);
        putDataMapReq.getDataMap().putDouble(SUNSHINE_MAX_TEMP, high);
        putDataMapReq.getDataMap().putDouble(SUNSHINE_MIN_TEMP, low);
        ...
        pendingResult.setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(DataApi.DataItemResult dataItemResult) {
                Log.d(LOG_TAG, "Sending data status: " + dataItemResult.getStatus().isSuccess());
            }
        });
    }
